...
export default function PizzUpPage() {
  const game = getGame('pizzup');
  if (!game) return null;
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            url: 'https://suparion.com/games/pizzup',
            image: 'https://suparion.com/media/games/pizzup/PizzUpIcon.png',
      ...
      <section className="container-x py-20 grid lg:grid-cols-[1.1fr_1fr] gap-12 items-center">
        <div>
          {game.status === 'coming-soon' && (
            <span className="inline-block mb-5 text-xs uppercase tracking-[0.3em] text-accent font-semibold rounded-full border border-accent/30 bg-accent/10 px-4 py-2">
              Coming Soon
            </span>
          )}
