  ...
  return (
    <div className="pt-24 pb-20 container-x max-w-3xl mx-auto">
      ...
      <Section title="1. Introduction">
        <p>
          Suparion Games ("we", "us", or "our") built PizzUp! as a mobile game. This Privacy
          Policy explains what information is collected when you play PizzUp!, how it is used,
          and your rights regarding that information.
        </p>
        <p>
          By playing PizzUp!, you agree to the practices described in this policy. If you do not
      ...
      <Section title="2. Information We Collect">
        ...
        <ul className="list-disc list-inside space-y-1 ml-2">
          ...
          <li>
            ...
            IDFA on iOS) collected by Unity Ads to serve relevant rewarded ads.
          </li>
        </ul>
      </Section>
      ...
      <Section title="4. Advertising">
        <p>
          PizzUp! offers <strong>rewarded ads</strong>: short video ads that you can voluntarily
          choose to watch in exchange for in-game rewards. These ads are powered by{' '}
          <strong>Unity Ads</strong>. Unity Ads may collect and use your device's advertising
          identifier and other technical information to serve personalised or contextual ads. For
          players we know or believe to be under 13, ads are limited to non-personalised,
          contextual ads only (see Section 7).
        </p>
        <p>
          ...
          advertising ID at any time in the same menu. On iOS you can control this under{' '}
      ...
      <Section title="5. Analytics">
        <p>
          ...
          how players interact with PizzUp!. Data collected is anonymised and aggregated; it is
      ...
      <Section title="6. Leaderboards">
        <p>
          ...
          and processed by <strong>Unity Gaming Services (UGS)</strong> and displayed publicly to
          all players. Do not use your real name or any personal information as your username.
        </p>
        <p>
      ...
      <Section title="7. Children's Privacy">
        <p>
          PizzUp! is a family-friendly game suitable for players of all ages, including children
          under 13. We take additional steps to protect the privacy of younger players.
        </p>
        <p>
          For any user we know or have reason to believe is under 13, we do not knowingly collect
          personal information beyond what is strictly necessary to run the game, and we instruct
          our advertising and analytics partners to treat such traffic as child-directed. This
          means:
        </p>
        <ul className="list-disc list-inside space-y-1 ml-2">
          <li>
          ...
          <li>
            The leaderboard username is chosen by the player and is not required to play. We ask
            players not to use real names or any personal information as their username (see
            Section 6).
          </li>
        </ul>
        <p>
          We do not knowingly collect a child's real name, address, phone number, email, precise
          location, or photos. If you are a parent or guardian and believe your child has provided
          personal information through the game, please contact us at the address in Section 11
      ...
      <Section title="8. Data Retention">
        <p>
          Leaderboard data (username + score) is retained as long as the leaderboard is active or
          until you request deletion. Analytics data is retained in aggregated, anonymised form.
          Advertising identifiers are managed by the respective ad platform's own retention
          policies.
        </p>
      </Section>
      ...
      <Section title="10. Security">
        <p>
          We use commercially reasonable measures to protect the information we collect. However,
          no method of transmission or storage over the internet is 100% secure, and we cannot
      ...
      <Section title="12. Changes to This Policy">
        <p>
          ...
          with an updated "Last updated" date. Continued use of PizzUp! after changes constitutes
      ...
      <div className="pt-4 border-t border-white/5">
        <Link
          to="/games/pizzup/terms-of-service"
